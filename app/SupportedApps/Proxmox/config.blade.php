...
<div class="items" style="flex-wrap: wrap;">
    ...
    <div class="input">
        ...
        <p style="font-size: .8em;">Requires at least <code>Sys.Audit</code> permission for <code>/nodes</code> and <code>VM.Audit</code> permission for <code>/vms</code>, both propagated to the relevant objects.</p>
    </div>
    <div class="input">
